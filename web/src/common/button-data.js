export default {
  contactCareGuide: {
    text: 'Contact Care Guide',
    icon: 'white_icons/care-guide',
    onClick: 'careGuideClick'
  },
  ...
  requestInformation: {
    ...
    icon: 'white_icons/folded-paper',
    onClick: 'requestInformationClick'
  },
  requestMembershipCard: {
    text: 'Request Mailed Card',
    icon: 'description',
    onClick: 'requestMembershipCardClick',
    svgIcon: false
  },
  scheduleAppointment: {
  ...
  schedulePhoneCall: {
    ...
    icon: 'access_time',
    onClick: 'schedulePhoneCallClick',
    svgIcon: false
  },
  sendAMessage: {
    text: 'Send a Message',
