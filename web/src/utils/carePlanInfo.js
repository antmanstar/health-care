  ...
  switch (planId) {
    case HEART_HEALTH_PLAN_ID:
      return {
        ...
        note: 'This Care Plan focuses on controling blood pressure, weight, cholesterol, and much more.',
        description:
