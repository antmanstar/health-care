...
//import emailImg from '@evry-member-app/assets/images/vector/email.svg';
import cardImg from '@evry-member-app/assets/images/vector/white_icons/card.svg';
import foldedPaperImg from '@evry-member-app/assets/images/vector/white_icons/folded-paper.svg';
//import descriptionImg from '@evry-member-app/assets/images/vector/description.svg';
//import accessTimeImg from '@evry-member-app/assets/images/vector/access_time.svg';
//import chatImg from '@evry-member-app/assets/images/vector/chat.svg';
import medicalKitImg from '@evry-member-app/assets/images/vector/white_icons/medical-kit.svg';
//import libraryBooksImg from '@evry-member-app/assets/images/vector/library_books.svg';
import pencilImg from '@evry-member-app/assets/images/vector/white_icons/pencil.svg';
//import lockImg from '@evry-member-app/assets/images/vector/lock.svg';
//import verifiedUserImg from '@evry-member-app/assets/images/vector/verified_user.svg';
//import questionAnswerImg from '@evry-member-app/assets/images/vector/question_answer.svg';
import planIconHeartImg from '@evry-member-app/assets/images/vector/plan-icon-heart.svg';
import memberCardImg from '@evry-member-app/assets/images/vector/member-card.svg';
import arrowSelect from '@evry-member-app/assets/images/vector/arrow-select.svg';
import successIconImg from '@evry-member-app/assets/images/vector/success-icon.svg';
import activityInCircleImg from '@evry-member-app/assets/images/vector/activity-in-circle.svg';
import moneyInCircleImg from '@evry-member-app/assets/images/vector/money-in-circle.svg';
import checkInCircleImg from '@evry-member-app/assets/images/vector/check-in-circle.svg';
import feedbackPositiveImg from '@evry-member-app/assets/images/vector/feedback-positive.svg';
import feedbackNeutralImg from '@evry-member-app/assets/images/vector/feedback-neutral.svg';
import feedbackNegativeImg from '@evry-member-app/assets/images/vector/feedback-negative.svg';
import downloadImg from '@evry-member-app/assets/images/vector/download.svg';
//import searchImg from '@evry-member-app/assets/images/vector/search.svg';
import locationPinImg from '@evry-member-app/assets/images/vector/location_pin.svg';
//import filterImg from '@evry-member-app/assets/images/vector/filter.svg';
import carePlanIllustrationImg from '@evry-member-app/assets/images/vector/care-plan-illustration.svg';
import careGuidesIllustrationImg from '@evry-member-app/assets/images/vector/care-guides-illustration.svg';
import telemedicineIllustrationImg from '@evry-member-app/assets/images/vector/telemedicine-illustration.svg';
...
import expenseCalculatorImg from '@evry-member-app/assets/images/vector/expense-calculator.svg';
import healthAssessmentImg from '@evry-member-app/assets/images/vector/health-assessment.svg';
import mockMapImg from '@evry-member-app/assets/images/raster/mock_map.png';
...
import medicalServicesImg from '@evry-member-app/assets/images/vector/medical-services-black.svg';
import localPharmacyImg from '@evry-member-app/assets/images/vector/local-pharmacy-black.svg';

const images = {
  'activity-in-circle': activityInCircleImg,
  'app-store': appStoreImg,
  'arrow-select': arrowSelect,
  ...
  'check-in-circle': checkInCircleImg,
  download: downloadImg,
  'expense-calculator': expenseCalculatorImg,
  'feedback-positive': feedbackPositiveImg,
  'feedback-negative': feedbackNegativeImg,
  'feedback-neutral': feedbackNeutralImg,
  formulary: formularyImg,
  ...
  'white_icons/folded-paper': foldedPaperImg,
  'white_icons/medical-kit': medicalKitImg,
  ...
  'local-pharmacy-black': localPharmacyImg,
  'medical-services-black': medicalServicesImg
};
