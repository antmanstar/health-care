...
const theme = {
  ...
  components: {
    ...
    DateWrapper: styled.div`
      ${components.DateWrapper}
    `,
    DateWrapperIcon: styled.i`
      ${components.DateWrapperIcon}
    `,
    FormLabel: styled.h4`
    ...
    `,
    MobileModalBackButton: styled.button`
      ${components.MobileModalBackButton}
    `,
    MobileModalDivider: styled.div`
      ${components.MobileModalDivider}
    `,
    MobileModalTitleWrapper: styled.div`
      ${components.MobileModalTitleWrapper}
    `,
    MobileModalTitle: styled.h2`
      ${components.MobileModalTitle}
    `,
    MobileModalFlexColumn: styled.div`
      ${components.MobileModalFlexColumn}
    `,
    MobileSectionBackground: styled.div`
      ${components.MobileSectionBackground}
    `,
    MobileContainer: styled.div`
      ${components.MobileContainer}
    `,
    MobileContentWrapper: styled.div`
      ${components.MobileContentWrapper}
    `,
    MobileFixedBottomButton: styled.div`
      ${components.MobileFixedBottomButton}
    `,
    MobileInput: styled.input`
      ${components.MobileInput}
    `,
    MobileListTitle: styled.h2`
      ${components.MobileListTitle}
    `,
    MobileModalListTitle: styled.h2`
      ${components.MobileModalListTitle}
    `,
    MobileSectionInstruction: styled.p`
      ${components.MobileSectionInstruction}
    `,
    MobileTextArea: styled.textarea`
      ${components.MobileTextArea}
    `,
    ModalBody: styled.div`
      ${components.ModalBody}
    `,
    ModalButtonsCenter: styled.div`
      ${components.ModalButtonsCenter}
    `,
    ModalButtonsRight: styled.div`
      ${components.ModalButtonsRight}
    `,
    ModalHalfColumn: styled.div`
      ${components.ModalHalfColumn}
    `,
    ModalHeader: styled.div`
      ${components.ModalHeader}
    `,
    ModalSectionDivider: styled.hr`
      ${components.ModalSectionDivider}
    `,
    ModalTextArea: styled.textarea`
      ${components.ModalTextArea}
    `,
    ...
    `,
    SectionBackground: styled.div`
      ${components.SectionBackground}
    `,
    ...
    `,
    TrimmedHeader: styled.div`
      ${components.TrimmedHeader}
    `,
    TwoColumnRow: styled.div`
      ${components.TwoColumnRow}
    `
  }
};
